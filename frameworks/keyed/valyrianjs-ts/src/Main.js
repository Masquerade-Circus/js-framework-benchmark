  ...
  return <div className="container">
    ...
    <table className="table table-hover table-striped test-data">
      <tbody id="tbody" v-for={Store.state.data}>
        {
          ({id, label}) => <tr key={id} state={label} className={id === Store.state.selected ? 'danger' : ''} shouldupdate={(n, o) => n.props.className !== o.props.className || n.props.state !== o.props.state }>
